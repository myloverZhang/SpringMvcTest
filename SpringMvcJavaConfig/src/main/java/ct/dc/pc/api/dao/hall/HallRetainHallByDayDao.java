 ...
 */
@Repository
public class HallRetainHallByDayDao extends RepositoryBase implements IHallRetainHallByDayDao{
    @Override
    @Value("${mongo.uri}")
    ...
    @Override
    @Value("${mongo.hall.retainHallByDay}")
     ...
     * @return
     */
    public ArrayList<HallRetainHallByDayPo> findByGroup(int group, int beginDate, int endDate) {
     ...
     */
    @Override
    public ArrayList<HallRetainHallByDayPo> find(int beginDate, int endDate) {
     ...
     * @return
     */
    private ArrayList<HallRetainHallByDayPo> findByDocument(Document query){
        ArrayList<HallRetainHallByDayPo> results = new ArrayList<HallRetainHallByDayPo>();
        for (Document info:collectionInstance().find(query)){
            HallRetainHallByDayPo result = new HallRetainHallByDayPo();
