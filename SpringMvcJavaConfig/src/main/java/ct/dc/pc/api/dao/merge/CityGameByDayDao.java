 ...
 */
@Repository
public class CityGameByDayDao extends RepositoryBase implements ICityGameByDayDao{
    ...
    @Override
    @Value("${mongo.merge.cityGameByDay}")
     ...
     * @return
     */
    public ArrayList<MergeLoginByDayPo> find(String city, int beginDate, int endDate)
            throws ExecutionException, InterruptedException {
        Document match = new Document().append("city",city)
     ...
     * @return
     */
    public ArrayList<MergeLoginDetailsByDayPo> findDetails(String city, int beginDate, int endDate, int game)
            throws ExecutionException, InterruptedException {
        Document match = new Document().append("city",city)
                .append("game",game)
                .append("date",new Document().append("$gte",beginDate).append("$lte",endDate));
