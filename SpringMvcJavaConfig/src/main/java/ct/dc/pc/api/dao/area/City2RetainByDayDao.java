 ...
 */
@Repository
public class City2RetainByDayDao extends RepositoryBase implements ICity2RetainByDayDao{
    @Override
    @Value("${mongo.uri}")
    ...
    @Override
    @Value("${mongo.area.cityRetainByDay}")
     ...
     * @return
     */
    public ArrayList<AreaRetainByDayPo> findByCity(String city, int beginDate, int endDate) {
        Document query = new Document().append("area",city)
