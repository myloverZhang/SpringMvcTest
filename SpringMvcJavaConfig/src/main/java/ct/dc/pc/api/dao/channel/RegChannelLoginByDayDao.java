...
import ct.dc.pc.api.dao.channel.interfaces.IRegChannelLoginByDayDao;
import ct.dc.pc.api.model.po.channel.RegChannelLoginByDayPo;
 ...
 */
@Repository
public class RegChannelLoginByDayDao extends RepositoryBase implements IRegChannelLoginByDayDao{
    @Override
    ...
    @Override
    @Value("${mongo.channel.loginByDay.regChannel}")
     ...
     */
    @Override
    public ArrayList<RegChannelLoginByDayPo> find(int beginDate, int endDate, int limitNum) {
     ...
     */
    @Override
    public ArrayList<RegChannelLoginByDayPo> find(int beginDate, int endDate) {
     ...
     */
    @Override
    public ArrayList<RegChannelLoginByDayPo> findByChannel(long channel, int beginDate, int endDate, int limitNum) {
     ...
     */
    @Override
    public ArrayList<RegChannelLoginByDayPo> findByChannels(ArrayList<Long> channels, int beginDate, int endDate, int limitNum) {
    ...
    private ArrayList<RegChannelLoginByDayPo> findByDocuments(Document match, int limit){
        ArrayList<RegChannelLoginByDayPo> results = new ArrayList<>();
    ...
    private ArrayList<RegChannelLoginByDayPo> findByDocuments(Document matchWithDates,Document matchWithEndDate, int limit){
        ArrayList<RegChannelLoginByDayPo> results = new ArrayList<>();
     ...
     * @return
     */
    private RegChannelLoginByDayPo parseEntity(Document info){
        RegChannelLoginByDayPo result = new RegChannelLoginByDayPo();
