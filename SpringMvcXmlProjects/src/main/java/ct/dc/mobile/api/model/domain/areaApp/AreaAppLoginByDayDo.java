 ...
 */
public class AreaAppLoginByDayDo implements Serializable{
    private Long id;
    private Integer loginUnitNum;
    private Integer times;
    private Integer type;

    public AreaAppLoginByDayDo() {
    }

    public AreaAppLoginByDayDo(Long id, Integer loginUnitNum, Integer times, Integer type) {
        this.id = id;
