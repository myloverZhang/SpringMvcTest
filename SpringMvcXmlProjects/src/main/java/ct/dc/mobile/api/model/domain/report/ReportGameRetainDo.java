 ...
 */
public class ReportGameRetainDo implements Serializable{
    ...
    public ReportGameRetainDo() {
    }

    public ReportGameRetainDo(Integer date, Long app, String appName, Integer usersNew, Integer usersD1, Integer usersD3, Integer usersD7, Integer usersD14, Integer usersD30, Integer hardsNew, Integer hardsD1, Integer hardsD3, Integer hardsD7, Integer hardsD14, Integer hardsD30) {
        this.date = date;
        this.app = app;
