 ...
 */
public class AppLoginByDayDo implements Serializable{
    ...
    public AppLoginByDayDo() {
    }

    public AppLoginByDayDo(Integer date, Integer times, Integer type, Integer users1D1, Integer users3D1, Integer users7D1, Integer users14D1, Integer users30D1) {
        this.date = date;
        this.times = times;
        this.type = type;
