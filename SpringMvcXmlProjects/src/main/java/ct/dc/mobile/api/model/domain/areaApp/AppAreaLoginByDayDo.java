 ...
 */
public class AppAreaLoginByDayDo implements Serializable{
    private String id;
    private Integer loginUnitNum;
    private Integer times;
    private Integer type;

    public AppAreaLoginByDayDo() {
    }

    public AppAreaLoginByDayDo(String id, Integer loginUnitNum, Integer times, Integer type) {
        this.id = id;
