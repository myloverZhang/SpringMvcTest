 ...
 */
public class ChannelRetainPo implements Serializable{
    private Long app;
    ...
    public ChannelRetainPo() {
    }

    public ChannelRetainPo(Long app, Long channel, Integer date, Integer usersNew, Integer usersD1, Integer usersD3,
                           Integer usersD7, Integer usersD14, Integer usersD30, Integer hardsNew, Integer hardsD1,
                           Integer hardsD3, Integer hardsD7, Integer hardsD14, Integer hardsD30) {
        this.app = app;
