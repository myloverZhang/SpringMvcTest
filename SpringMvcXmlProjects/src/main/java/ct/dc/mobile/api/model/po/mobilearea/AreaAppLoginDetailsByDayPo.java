 ...
 */
public class AreaAppLoginDetailsByDayPo implements Serializable{
    ...
    public AreaAppLoginDetailsByDayPo() {
    }

    public AreaAppLoginDetailsByDayPo(Integer date, Integer loginUnitNum, Integer times, Integer type) {
        this.date = date;
    ...
    public String toString() {
        return "AreaAppLoginDetailsByDayPo{" +
                "date=" + date +
